(function() {
        ...
        switch (typeof b) {
          ...
          case "object":
            ...
            if ("array" == fa(b)) {
                var d = b.length;
                c.push("[");
                for (var e = "", f = 0; d > f; f++) c.push(e), e = b[f], oa(a, a.gc ? a.gc.call(b, String(f), e) : e, c), 
                e = ",";
                c.push("]");
                break;
            }
    ...
    function ta(a) {
        for (var b = [], c = 0, d = 0; a.length > d; d++) {
            var e = a.charCodeAt(d);
            e >= 55296 && 56319 >= e && (e -= 55296, d++, y(a.length > d, "Surrogate pair missing trail surrogate."), 
            e = 65536 + (e << 10) + (a.charCodeAt(d) - 56320));
            128 > e ? b[c++] = e : (2048 > e ? b[c++] = 192 | e >> 6 : (65536 > e ? b[c++] = 224 | e >> 12 : (b[c++] = 240 | e >> 18, 
            b[c++] = 128 | 63 & e >> 12), b[c++] = 128 | 63 & e >> 6), b[c++] = 128 | 63 & e);
        }
        return b;
    }
    function z(a, b, c, d) {
    ...
    function Ba(a, b, c, d) {
        ...
        u(b) && b.length > 10485760 / 3 && ta(b).length > 10485760 && g(Error(a + "contains a string greater than 10485760 utf8 bytes" + Ca(d) + " ('" + b.substring(0, 50) + "...')"));
    ...
    function Fa(a, b, c, d) {
        !(d && !s(c) || c === k || ha(c) || u(c) || ia(c) && C(c, ".sv") || !g(Error(A(a, b, d) + "must be a valid firebase priority (a string, number, or null).")));
    }
    function Ga(a, b, c) {
        if (!c || s(b)) switch (b) {
          case "value":
    ...
    function J(a) {
        ...
        if (1 == arguments.length) {
            this.m = a.split("/");
            for (var b = 0, c = 0; this.m.length > c; c++) this.m[c].length > 0 && (this.m[b] = this.m[c], 
            b++);
            this.m.length = b;
            this.Z = 0;
    ...
    function K(a, b) {
        for (var e, c = b instanceof J ? b : new J(b), d = a; (e = E(c)) !== k; ) d = new Pa(e, d, wa(d.z.children, e) || new Oa()), 
        c = Ma(c);
        return d;
    }
    function Qa(a, b) {
    ...
    function tb(a, b) {
        var c;
        c || (c = 0);
        for (var d = a.ud, e = c; c + 64 > e; e += 4) d[e / 4] = b[e] << 24 | b[e + 1] << 16 | b[e + 2] << 8 | b[e + 3];
        for (e = 16; 80 > e; e++) {
            var f = d[e - 3] ^ d[e - 8] ^ d[e - 14] ^ d[e - 16];
            d[e] = 4294967295 & (f << 1 | f >>> 31);
        }
        c = a.B[0];
        for (var p, h = a.B[1], i = a.B[2], m = a.B[3], n = a.B[4], e = 0; 80 > e; e++) 40 > e ? 20 > e ? (f = m ^ h & (i ^ m), 
        p = 1518500249) : (f = h ^ i ^ m, p = 1859775393) : 60 > e ? (f = h & i | m & (h | i), 
        p = 2400959708) : (f = h ^ i ^ m, p = 3395469782), f = 4294967295 & (c << 5 | c >>> 27) + f + n + p + d[e], 
        n = m, m = i, i = 4294967295 & (h << 30 | h >>> 2), h = c, c = f;
        a.B[0] = 4294967295 & a.B[0] + c;
        a.B[1] = 4294967295 & a.B[1] + h;
        a.B[2] = 4294967295 & a.B[2] + i;
        a.B[3] = 4294967295 & a.B[3] + m;
        a.B[4] = 4294967295 & a.B[4] + n;
    }
    function Cb() {
    ...
    function Mb(a, b) {
        ...
        for (var c = b ? Lb : Kb, d = [], e = 0; a.length > e; e += 3) {
            var f = a[e], h = a.length > e + 1, i = h ? a[e + 1] : 0, m = a.length > e + 2, n = m ? a[e + 2] : 0, p = f >> 2, f = (3 & f) << 4 | i >> 4, i = (15 & i) << 2 | n >> 6, n = 63 & n;
            m || (n = 64, h || (i = 64));
    ...
    function Pb(a) {
        ...
        for (var d = 63; d >= 56; d--) a.rc[d] = 255 & c, c /= 256;
        tb(a, a.rc);
        for (d = c = 0; 5 > d; d++) for (var e = 24; e >= 0; e -= 8) b[c++] = 255 & a.B[d] >> e;
        return Mb(b);
    }
    function Qb() {
        for (var a = "", b = 0; arguments.length > b; b++) a = ga(arguments[b]) ? a + Qb.apply(k, arguments[b]) : "object" == typeof arguments[b] ? a + w(arguments[b]) : a + arguments[b], 
        a += " ";
        return a;
    }
    function L() {
    ...
    function Yb(a, b) {
        if (a === b) return 0;
        var c = Zb(a), d = Zb(b);
        return c !== k ? d !== k ? c - d : -1 : d !== k ? 1 : b > a ? -1 : 1;
    }
    function $b(a, b) {
    ...
    function La(a) {
        ...
        b.sort();
        c = "{";
        for (var d = 0; b.length > d; d++) 0 !== d && (c += ","), c += w(b[d]), c += ":", 
        c += La(a[b[d]]);
        return c + "}";
    }
    function ac(a, b) {
        if (b >= a.length) return [ a ];
        for (var c = [], d = 0; a.length > d; d += b) d + b > a ? c.push(a.substring(d, a.length)) : c.push(a.substring(d, d + b));
        return c;
    }
    function bc(a, b) {
        if ("array" == fa(a)) for (var c = 0; a.length > c; ++c) b(c, a[c]); else cc(a, b);
    }
    function dc(a) {
        y(!Da(a));
        var b, c, d, e;
        0 === a ? (d = c = 0, b = -1/0 === 1 / a ? 1 : 0) : (b = 0 > a, a = Math.abs(a), 
    ...
    function Zb(a) {
        return ec.test(a) && (a = Number(a), a >= -2147483648 && 2147483647 >= a) ? a : k;
    }
    function fc(a) {
        try {
            a();
    ...
    function sc(a, b) {
        ...
        a: {
            ...
            for (var e = c.length, f = u(c) ? c.split("") : c, h = 0; e > h; h++) if (h in f && d.call(aa, f[h])) {
                d = h;
                break a;
            }
            d = -1;
    ...
    function Mc(a) {
        if (a.pc && a.ic && a.Lc.count() < (a.Cb.length > 0 ? 2 : 1)) {
            a.vc++;
            var b = {};
            b.id = a.Gd;
            b.pw = a.Hd;
            b.ser = a.vc;
            for (var b = a.Lb(b), c = "", d = 0; a.Cb.length > 0; ) {
                if (!(1870 >= a.Cb[0].ad.length + 30 + c.length)) break;
            ...
            try {
                if (a.ic) {
                    ...
                    d.onload = d.onreadystatechange = function() {
                        var a = d.readyState;
                        a && "loaded" !== a && "complete" !== a || (d.onload = d.onreadystatechange = k, 
    ...
    function Vc(a) {
        var b;
        var c = a.Wc;
        c.lc.length > 0 ? b = c.lc[0] : g(Error("No transports available"));
    ...
    function Xc(a, b) {
        return function(c) {
            b === a.L ? (a.L = k, c || 0 !== a.wa ? 1 === a.wa && a.e("Realtime connection lost.") : (a.e("Realtime connection failed."), 
            "s-" === a.K.fa.substr(0, 2) && (nb.remove("host:" + a.K.host), a.K.fa = a.K.host)), 
            a.close()) : b === a.A ? (c = a.A, a.A = k, (a.Jb === c || a.Hb === c) && a.close()) : a.e("closing an old connection");
        };
    }
    function Wc(a, b) {
        return function(c) {
            if (2 != a.wa) if (b === a.Hb) {
                ...
                if ("c" == d) {
                    if (d = $b("t", c), "d" in c) if (c = c.d, "h" === d) {
                        ...
                        a.jc = c.s;
                        qb(a.K, f);
                        0 == a.wa && (a.L.start(), c = a.L, a.e("Realtime connection established."), a.L = c, 
                        a.wa = 1, a.xb && (a.xb(d), a.xb = k), "5" !== e && M("Protocol version mismatch detected"), 
                        c = a.Wc.lc.length > 1 ? a.Wc.lc[1] : k) && (a.A = new c("c:" + a.id + ":" + a.Yc++, a.K, a.jc), 
                        a.A.open(Wc(a, a.A), Xc(a, a.A)));
                    } else if ("n" === d) {
                        a.e("recvd end transmission on primary");
                        a.Hb = a.A;
                        for (c = 0; a.$b.length > c; ++c) a.Xb(a.$b[c]);
                        a.$b = [];
                        Yc(a);
    ...
    function xd(a, b) {
        if (0 !== b.length) for (var c = 0; b.length > c; c++) a.Ta.push(b[c]);
    }
    function yd(a) {
    ...
    function Ad(a, b, c, d, e) {
        ...
        for (var h = 0; f.length > h; h++) if (f[h].type === b) {
    ...
    function Jd(a, b, c, d, e) {
        var x, P, I, G, f = l, h = !a.Ob || !K(a.Ob, b).f(), i = [], m = [], n = [], p = [], q = {}, t = {};
        x = c.Ua();
        I = Za(x);
        P = d.Ua();
        for (G = Za(P); I !== k || G !== k; ) {
            ...
            if (0 > c) f = wa(q, I.key), s(f) ? (n.push({
                ...
                if (c > 0) f = wa(t, G.key), s(f) ? (n.push({
                    zc: m[f],
                    Tc: G
                }), m[f] = k) : (q[G.key] = i.length, i.push(G)), f = j; else {
                    c = b.F(G.key);
                    (c = Id(a, c, I.value, G.value)) && (p.push(G), f = j);
        ...
        for (h = 0; m.length > h; h++) (q = m[h]) && (c = b.F(q.key), Id(a, c, q.value, N), 
        e.push(new V("child_removed", q.value, q.key)));
        for (h = 0; i.length > h; h++) (q = i[h]) && (c = b.F(q.key), m = d.ea(q.key, q.value), 
        Id(a, c, N, q.value), e.push(new V("child_added", q.value, q.key, m)));
        for (h = 0; n.length > h; h++) q = n[h].zc, i = n[h].Tc, c = b.F(i.key), m = d.ea(i.key, i.value), 
        e.push(new V("child_moved", i.value, i.key, m)), (c = Id(a, c, q.value, i.value)) && p.push(i);
        for (h = 0; p.length > h; h++) a = p[h], m = d.ea(a.key, a.value), e.push(new V("child_changed", a.value, a.key, m));
        return f;
    }
    function Kd() {
        this.S = this.xa = k;
    ...
    function Pd(a, b, c) {
        for (var d = 0; a.length > d; d++) if (!a[d](b, c.j())) return l;
        return j;
    }
    function Qd(a, b) {
        this.u = a;
    ...
    function Td(a, b, c, d, e) {
        ...
        if (h = f) {
            h = l;
            for (var i = f.na.length - 1; i >= 0; i--) {
                var m = f.na[i];
                if (!(c && m.type !== c || d && m.X !== d || e && m.T !== e) && (f.na.splice(i, 1), 
                h = j, c && d)) break;
            }
            h = h && !(f.na.length > 0);
        }
    ...
    function W(a, b, c) {
        ...
        var e = a.Vb, f = a.g.ra;
        a.Vb = f;
        for (var h = {}, i = 0; c.length > i; i++) h[c[i].toString()] = j;
    ...
    function Sd(a, b) {
        if (a.u) {
            var h, c = a.u, d = b.path(), e = b.toString(), f = b.Za(), i = b.keys(), m = Ld(b), n = a.u, p = function(c) {
                if ("ok" !== c) {
                    var d = "Unknown Error";
    ...
    function je(a, b) {
        ...
        if (c.k() !== k) {
            ...
            if (xb(d, function(a) {
                ...
                for (var e = c.path(), f = 0; d.length > f; f++) y(1 === d[f].status, "tryToSendTransactionQueue_: items in queue should all be run."), 
                d[f].status = 2, d[f].nd++;
                c = T(a.g.I, e).hash();
                U(a.g.I, e, T(a.g.ma, e));
                for (var h = T(a.fb, e).V(j), i = Nb(), m = {}, n = 0; d.length > n; n++) d[n].qc && (m[d[n].path.toString()] = d[n].path);
                var q, p = [];
                for (q in m) p.push(m[q]);
                for (f = 0; p.length > f; f++) Qa(K(a.g.Bb, p[f]), i);
                a.u.put(e.toString(), h, function(b) {
                    ...
                    if ("ok" === b) {
                        b = [];
                        for (f = 0; d.length > f; f++) d[f].status = 3, d[f].C && (c = me(a, d[f].path), 
                        b.push(v(d[f].C, k, k, j, c))), d[f].nc();
                        ke(a, K(a.eb, e));
                        je(a);
                        for (f = 0; b.length > f; f++) fc(b[f]);
                    } else {
                        if ("datastale" === b) for (f = 0; d.length > f; f++) d[f].status = 4 === d[f].status ? 5 : 1; else {
                            M("transaction at " + e + " failed: " + b);
                            for (f = 0; d.length > f; f++) d[f].status = 5, d[f].oc = b;
                        }
                        b = fe(a, e);
                        W(a.G, b, [ e ]);
                    }
    ...
    function fe(a, b) {
        ...
        U(a.fb, d, T(a.g.I, d));
        if (0 !== e.length) {
            for (var f = c = T(a.g.ma, d), h = [], i = 0; e.length > i; i++) {
                var p, m = Na(d, e[i].path), n = l;
                y(m !== k, "rerunTransactionsUnderNode_: relativePath should not be null.");
                if (5 === e[i].status) n = j, p = e[i].oc; else if (1 === e[i].status) if (e[i].nd >= 25) n = j, 
                p = "maxretry"; else {
    ...
    function oe(a, b, c) {
        var d = b.k();
        if (d !== k) for (var e = 0; d.length > e; e++) c.push(d[e]);
        b.w(function(b) {
            oe(a, b, c);
        });
    }
    function ke(a, b) {
        var c = b.k();
        if (c) {
            for (var d = 0, e = 0; c.length > e; e++) 3 !== c[e].status && (c[d] = c[e], d++);
            c.length = d;
            Qa(b, c.length > 0 ? c : k);
        }
        b.w(function(b) {
    ...
    function pe(a) {
        var b = a.k();
        if (b !== k) {
            for (var c = [], d = -1, e = 0; b.length > e; e++) 4 !== b[e].status && (2 === b[e].status ? (y(d === e - 1, "All SENT items should be at beginning of queue."), 
            d = e, b[e].status = 4, b[e].oc = "set") : (y(1 === b[e].status), b[e].nc(), b[e].C && c.push(v(b[e].C, k, Error("set"), l, k))));
            -1 === d ? Qa(a, k) : b.length = d + 1;
            for (e = 0; c.length > e; e++) fc(c[e]);
        }
    }
    function me(a, b) {
        var c = new H(a, b);
    ...
    function H() {
        ...
        if (arguments[0] instanceof be) c = arguments[0], a = arguments[1]; else {
            ...
            if (u(d)) {
                ...
                if (3 == m.length) {
                    ...
                    if ("firebase" === m[1]) Wb(a + " is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"); else {
                        ...
                        f = "";
                        d = ("/" + d).split("/");
                        for (i = 0; d.length > i; i++) if (d[i].length > 0) {
                            h = d[i];
                            try {
            ...
            b = new J(f);
            e = b.toString();
            (d = !u(a.host)) || (d = 0 === a.host.length) || (d = !za(a.Sb)) || (d = 0 !== e.length) && (e && (e = e.replace(/^\/*\.info(\/|$)/, "/")), 
    ...
    r = J.prototype;
    r.toString = function() {
        for (var a = "", b = this.Z; this.m.length > b; b++) "" !== this.m[b] && (a += "/" + this.m[b]);
        return a || "/";
    };
    r.parent = function() {
        if (this.Z >= this.m.length) return k;
        for (var a = [], b = this.Z; this.m.length - 1 > b; b++) a.push(this.m[b]);
        return new J(a, 0);
    };
    r.F = function(a) {
        for (var b = [], c = this.Z; this.m.length > c; c++) b.push(this.m[c]);
        if (a instanceof J) for (c = a.Z; a.m.length > c; c++) b.push(a.m[c]); else {
            a = a.split("/");
            for (c = 0; a.length > c; c++) a[c].length > 0 && b.push(a[c]);
        }
        return new J(b, 0);
    };
    r.f = function() {
    ...
    sb.prototype.update = function(a, b) {
        ...
        if (u(a)) for (;b > e; ) c[d++] = a.charCodeAt(e++), 64 == d && (tb(this, c), d = 0); else for (;b > e; ) c[d++] = a[e++], 
        64 == d && (tb(this, c), d = 0);
        this.ob = d;
        this.Vc += b;
    };
    var ub = Array.prototype, vb = ub.forEach ? function(a, b, c) {
        ...
        for (var d = a.length, e = u(a) ? a.split("") : a, f = 0; d > f; f++) f in e && b.call(c, e[f], f, a);
    }, wb = ub.map ? function(a, b, c) {
        return ub.map.call(a, b, c);
    } : function(a, b, c) {
        for (var d = a.length, e = Array(d), f = u(a) ? a.split("") : a, h = 0; d > h; h++) h in f && (e[h] = b.call(c, f[h], h, a));
        return e;
    }, xb = ub.every ? function(a, b, c) {
        return ub.every.call(a, b, c);
    } : function(a, b, c) {
        for (var d = a.length, e = u(a) ? a.split("") : a, f = 0; d > f; f++) if (f in e && !b.call(c, e[f], f, a)) return l;
        return j;
    };
    var yb, zb, Ab, Bb;
    Bb = Ab = zb = yb = l;
    ...
    rc.prototype.Xc = function(a) {
        for (var b = this.sb[a] || [], c = 0; b.length > c; c++) b[c].X.apply(b[c].T, Array.prototype.slice.call(arguments, 1));
    };
    ...
    rc.prototype.ub = function(a, b, c) {
        sc(this, a);
        for (var a = this.sb[a] || [], d = 0; a.length > d; d++) if (a[d].X === b && (!c || c === a[d].T)) {
            a.splice(d, 1);
            break;
        }
    };
    ...
    zc.prototype.kd = function() {
        var d, a = this.kc.get(), b = {}, c = l;
        for (d in a) a[d] > 0 && C(this.Sc, d) && (b[d] = a[d], c = j);
        c && (a = this.u, a.P && (b = {
            c: b
            ...
            if (!d.Ja) {
                d.ka = new Kc(function(a, b, c) {
                    ...
                    for (c.ac[a] = b; c.ac[c.Qa]; ) {
                        var e = c.ac[c.Qa];
                        delete c.ac[c.Qa];
                        for (var f = 0; e.length > f; ++f) if (e[f]) {
                            var h = c;
                            fc(function() {
                                h.Jc(e[f]);
                            });
    ...
    Hc.prototype.send = function(a) {
        ...
        for (var a = ta(a), a = Mb(a, j), a = ac(a, 1840), b = 0; a.length > b; b++) {
            var c = this.ka;
            c.Cb.push({
                Qd: this.Zc,
                Vd: a.length,
    ...
    S.isAvailable = function() {
        ...
        if ("undefined" != typeof navigator && navigator.userAgent) {
            ...
            b && b.length > 1 && 4.4 > parseFloat(b[1]) && (a = j);
        }
        return !a && Nc !== k && !Oc;
    };
    S.prototype.send = function(a) {
        ...
        xc(this.$, "bytes_sent", a.length);
        a = ac(a, 16384);
        a.length > 1 && this.W.send(String(a.length));
        for (var b = 0; a.length > b; b++) this.W.send(a[b]);
    };
    ...
    r.xb = function(a) {
        ...
        for (b = 0; this.U.length > b; b++) this.U[b] && md(this, b);
    ...
    r.gd = function() {
        ...
        this.P = l;
        this.ja = k;
        for (var a = 0; this.U.length > a; a++) {
            var b = this.U[a];
            b && "h" in b.ld && b.Md && (b.C && b.C("disconnect"), delete this.U[a], this.zb--);
        }
        0 === this.zb && (this.U = []);
        if (this.Na) this.gb ? this.rb && (new Date().getTime() - this.rb > 3e4 && (this.qa = 1e3), 
    ...
    wd.prototype.Eb = function() {
        for (var a = 0; this.Ta.length > a; a++) if (this.Ta[a]) {
            var b = this.Ta[a];
            this.Ta[a] = k;
            yd(b);
        }
    ...
    Nd.prototype.dc = function(a, b) {
        ...
        if (s(this.J.Da)) if (s(this.J.da)) {
            ...
            c.push(function(a, b) {
                var c = Xb(b, i);
                return c > 0 || 0 === c && Yb(a, f) >= 0;
            });
        }
        for (var m = [], n = [], p = [], q = [], t = 0; b.length > t; t++) {
        ...
        for (t = 0; n.length > t; t++) c = n[t], x = this.i.ea(c.aa, c.ta), m.push(new V("child_added", c.ta, c.aa, x));
        for (t = 0; p.length > t; t++) c = p[t], x = this.i.ea(c.aa, c.ta), m.push(new V("child_moved", c.ta, c.aa, x));
        for (t = 0; q.length > t; t++) c = q[t], x = this.i.ea(c.aa, c.ta), m.push(new V("child_changed", c.ta, c.aa, x));
        this.pb && m.length > 0 && m.push(new V("value", this.i));
        return m;
    };
    ...
    Qd.prototype.Mb = function(a, b, c, d, e) {
        ...
        if (i.contains(m)) a = i.get(m), Ad(a, b, c, d, e); else {
            ...
            (b = (b = Ta(K(this.la, f), function(a) {
                var b;
                (b = a.k()) && (b = a.k().defaultView()) && (b = a.k().defaultView().pb);
                if (b) return j;
    ...
    r.Yb = function(a, b, c) {
        this.wc++;
        var d, e, f = [];
        a.length >= 9 && a.lastIndexOf(".priority") === a.length - 9 ? (d = new J(a.substring(0, a.length - 9)), 
    ...
    r.update = function(a, b, c) {
        ...
        var m, d = T(this.g.ma, a), e = j, f = [], h = ee(this), i = [];
        for (m in b) {
    ...
    r.fc = function(a, b, c, d) {
        if (".info" === E(a.path)) this.Ec.fc(a, b, c, d); else {
            b = this.G.fc(a, b, c, d);
            if (c = b !== k) {
                for (var c = this.g, d = a.path, e = [], f = 0; b.length > f; ++f) e[f] = T(c.sa, b[f]);
                U(c.sa, d, N);
                for (f = 0; b.length > f; ++f) U(c.sa, b[f], e[f]);
                c = td(c, d);
            }
    ...
    qe = function(a) {
        var b = a === re;
        re = a;
        for (var c = Array(8), d = 7; d >= 0; d--) c[d] = "-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz".charAt(a % 64), 
        a = Math.floor(a / 64);
        y(0 === a);
        a = c.join("");
        if (b) {
            for (d = 11; d >= 0 && 63 === se[d]; d--) se[d] = 0;
            se[d]++;
